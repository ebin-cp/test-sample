...
import authenticate from "../auth/websocket.js";
import onSocketError from "../errors/websocket.js";
import { clientDetails, wss } from "./websocket.js";
const server = createServer();
server.on("request", async (req, res) => {
	const routeKey = `${req.url}`;
	const response = {
		statusCode: 403,
